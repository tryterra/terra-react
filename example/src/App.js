...
export default function App() {
  ...
  function initThings(devId, token, connection) {
    ...
    initTerra(devId, 'reid').then((aa) => {
      ...
      initConnection(connection, token, true).then((a) => {
        ...
        getNutrition(connection, startDate, new Date())
          .then((d) => setResults((r) => ({ ...r, getNutrition: d.success })))
          .catch((e) => console.log(e));
        getSleep(connection, startDate, new Date())
          .then((d) => setResults((r) => ({ ...r, getSleep: d.success })))
          .catch((e) => console.log(e));
  ...
  return React.createElement(
    ...
    React.createElement(Text, null, 'Hello from Terra'),
    Object.entries(results).map(([k, v], i) =>
      React.createElement(
        ...
        k,
        ': ',
        v !== undefined || v !== null ? v.toString() : 'undefined'
      )
    )
  );
}
