...
- Bump TerraiOS SDK to 1.4.9 (https://github.com/tryterra/TerraAndroid/wiki/Change-Log)

## 1.4.8

### Changed
- Bump TerraiOS SDK to 1.3.10 (https://github.com/tryterra/TerraiOS/wiki/Change-Log)
- Bump TerraiOS SDK to 1.4.8 (https://github.com/tryterra/TerraAndroid/wiki/Change-Log)
