...
## 1.9.2
- Bump TerraiOS SDK to 1.7.4 (https://github.com/tryterra/TerraiOS/wiki/Change-Log)
...
## 1.8.10
- Bump TerraAndroid SDK to 1.6.2 (https://github.com/tryterra/TerraAndroid/wiki/Change-Log)

## 1.8.9
- Bump Tag latest version

## 1.8.8
- Bump TerraiOS SDK to 1.6.29 (https://github.com/tryterra/TerraiOS/wiki/Change-Log)

## 1.8.7
- Update react native config package

## 1.8.6
- Add Plannedworkouts for iOS
...
### Changed
- Added Expo Plugin Support for Expo v53+

## 1.8.0

### Changed
- Add Expo Plugin Support
...
### Changed
- Bump TerraAndroid SDK to 1.5.5 (https://github.com/tryterra/TerraAndroid/wiki/Change-Log)
